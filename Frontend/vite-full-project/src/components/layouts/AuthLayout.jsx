                ...
                <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
                    ...
                    <div className='grid grid-cols-1 z-20'>
                        <StatsInfoCard
                            ...
                            label="Vérifie des Revenus et Dépenses"
                            value="430,000"
                            color="bg-purple-500"
                        />
                    </div>
...
const StatsInfoCard = ({ icon, label, value, color }) => {
    ...
    return (
        <div className=" flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/20 border border-gray-200/10 z-10">
            ...
            <div>
                ...
                <span className='text-[20px]'>{value} frcfa</span>
            </div>
        </div>
    );
